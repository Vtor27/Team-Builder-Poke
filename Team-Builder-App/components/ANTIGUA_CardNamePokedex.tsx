  ...
  return (
    ...
    >
      ...
      <Animated.View
        ...
        className="absolute inset-0 flex-row items-center justify-around px-1 "
      >
        <Animated.Image
          ...
          resizeMode={"contain"}
        />
        <View className="flex-row items-center justify-center h-9/12 w-7/12 bg-white rounded-lg">
          <Text className="text-xl font-bold text-black text-center py-2 mr-2">
            # {pokemon.id}
          </Text>
          <Text className="text-2xl font-bold text-black text-center py2-">
            {pokemon.name}
          </Text>
        </View>
        <Image
...
export default ANTIGUA_NameCardPoke;
